...
// Pulls each active smart account's following list (via twitterapi.io) and upserts edges into Supabase.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    let q = supabase.from('smart_accounts').select('handle').eq('active', true);
